      ...
      <div className="bg-white rounded-3xl p-8 shadow-xl border border-slate-100 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-md mx-auto mb-8">
          <button 
            ...
            className="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-4 px-6 rounded-2xl transition shadow-md"
          >
            Enter Game Lobby
          </button>
          <button 
            onClick={handleLogout} 
            className="border border-slate-200 hover:bg-slate-50 text-slate-700 font-semibold py-4 px-6 rounded-2xl transition"
          >
            Sign Out
          </button>
        </div>
